...
export default function Letter() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            {/* 질문 영역 */}
            <div className="flex-1 flex flex-col items-center justify-center p-4 backdrop-blur-sm">
                <div className="text-center space-y-6">
                    <h1 className="text-base md:text-2xl font-bold text-gray-800 whitespace-pre-line">
                    ...
                    <div className="space-y-3">
                        {theseQuestion.answer.map((item, index) => (
                            <button
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 transition-colors text-xs md:text-base ${
