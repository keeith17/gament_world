...
export default function Result() {
    ...
    const result = winner
        ? resultData[winner as keyof typeof resultData]
        : null;
                    ...
                    <div className="flex-shrink-0 result-content-header">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {result.invitation.body.replace(
                                        /{{user}}/g,
                                        userName
                                    )}
                                </p>
                        ...
                        >
                            <div
                                style={{
                                    display: "flex",
                                    animation:
                                        "scroll-left 18s linear infinite",
                                }}
                            >
                                <div
                                    ...
                                    style={{
                                        ...
                                        fontFamily: "HSbombaram, sans-serif",
                                        textShadow:
                                            "0 0 10px #f38ec3, 0 0 20px #f38ec3",
                                        imageRendering: "pixelated",
                                        filter: "contrast(1.2) brightness(1.1)",
                                    }}
                                >
                                    매주 금요일 9시 치지직 전지적NT시점 ★ 1/30
                                    전격 토§토 방＠송※ 많관부
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                                <div
