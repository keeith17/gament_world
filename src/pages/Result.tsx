...
export default function Result() {
  ...
  return (
    <div
      className="min-h-screen max-h-screen overflow-y-auto p-4 sm:p-8 md:p-20"
      style={{
    ...
    >
      <div className="flex flex-col items-center justify-start min-h-screen p-2 sm:p-4 md:p-8">
        <div className="text-center space-y-6 max-w-2xl w-full px-2 sm:px-4">
